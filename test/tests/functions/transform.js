...
describe("Transform tests", ()=>{
	...
	describe("manual testing", ()=>{
		test("manual testing", ()=>{
			let code = smarts.transform(fs.readFileSync(__dirname+"/../../snippets/in/for in loop let.js", 'utf-8'))
			// fs.writeFileSync(__dirname+"/../../snippets/out/for in loop let.js", code.code)
			require(__dirname+"/../../snippets/out/for in loop let.js")
