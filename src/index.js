...
module.exports.init = props => {
  const { objList, stringList, reactiveSetter, vue, babel } = props || {}
  ...
  const smarts = {
    ...
    stringify (value, opts = {}) {
      let schema = {
        ...
        replace (key, value) {
          ...
          switch (typeof after.value) {
            ...
            case 'string':
              let ret =
                opts.known.get(after.key) ||
                smarts.setKnown(opts.known, opts.input, after)
              return ret
          }
          return after.value
        },
      ...
      Object.keys(schema).forEach(key => {
        if (
          smarts.getsmart(opts, smarts.epp(key), { undefined: true }, true)
            .undefined == true
        ) {
          opts[key] = schema[key]
        }
      ...
      return Object.keys(output).reduce((output, key) => {
        ...
        if (value instanceof String) {
          ...
          if (typeof tmp === 'object' && !parsed.get(tmp)) {
            ...
            output[key] = smarts.primitives(
              parser(key, smarts.revive(input, parsed, tmp, parser, opts))
            )
          } else {
            try {
          ...
          try {
            if (opts.replaceMode) {
              ...
              if (typeof value === 'object' && !parsed.get(value)) {
                ...
                output[key] = smarts.primitives(
                  parser(key, smarts.revive(input, parsed, value, parser, opts))
                )
              } else {
                try {
      ...
      let ret = /*javascript*/ `
        ...
        /*javascript*/ `\`val.$context.$variableMaps.\${${uuid}.closureIndex}\``
                  ...
                  /*javascript*/ `\`
						...
						return eval(${
              /*javascript*/ `\`(\${${uuid}.smarts.createScopedEval('${uuid}')})\``
            })(${uuid})
					}
				}
			`
    ...
    context (opts) {
      let uuid = smarts.gosmart.bind(this)(
        opts,
        'path.context.scope.uuid',
        smarts.jsUUID()
      )
    ...
    getPathUUID (opts) {
      if (
        ...
        return smarts.getPathUUID({ ...opts, path: opts.path.parentPath })
      return smarts.getNodeUUID({
        ...opts,
      ...
      let metaVisitor = {
        ...
        VariableDeclarator (path) {
          if (!path.node.inScope) {
            ...
            let parentPath = smarts.getsmart.bind(this)(
              path,
              'parentPath',
              undefined
            )
            if (
              ...
              let uuid = smarts.getPathUUID({ path })
              if (uuid) {
                let indexInParent = parentPath.node.declarations.indexOf(
                  path.node
                )
    ...
    merge (value1, value2, opts = {}, seen = new Map()) {
      ...
      props.forEach(prop => {
        ...
        if (
          smarts.getsmart.bind(this)(local.vue, 'reactiveSetter', false) &&
          smarts.getsmart.bind(this)(
            this,
            '$set',
            smarts.getsmart.bind(this)(local.vue, 'Vue.set', false)
          ) &&
          value1
        ) {
          ;(this.$set || local.vue.Vue.set)(value1, prop, newVal)
          if (
            typeof smarts.getsmart.bind(this)(
              window,
              '$store.commit',
              undefined
            ) == 'function'
          ...
          value1[prop] = newVal
          if (
            smarts.getsmart.bind(this)(local.vue, 'store', false) &&
            typeof smarts.getsmart.bind(this)(
              window,
              '$store.commit',
              undefined
      ...
      if (index >= 0 && list) {
        if (targets && targets.length && typeof targets.length == 'number') {
          for (var i = 0; i < targets.length; i++) {
            let value = smarts.getsmart.bind(this)(
              option,
              targets[i],
              undefined
            )
        ...
        for (var i = 0; i < list.length; i++) {
          ...
          for (var indKey = 0; indKey < keys.length; indKey++) {
            if (keymatchtype == 'broad') {
              if (
                list[i] &&
                smarts.getsmart.bind(this)(list[i], keys[indKey], undefined) ==
                  smarts.getsmart.bind(this)(option, keys[indKey], undefined) &&
                smarts.getsmart.bind(this)(list[i], keys[indKey], undefined) !==
                  undefined
              ) {
                return index ? i : true
    ...
    pushOpt (
      ...
      if (
        typeof list == 'object' &&
        !smarts.optIn(option, list, obj, keys, keymatchtype)
      ) {
        if (
          smarts.getsmart.bind(this)(local.vue, 'reactiveSetter', false) ||
          smarts.getsmart.bind(this)(local.vue, 'store', false)
      ...
      return index
        ? smarts.optIn(option, list, obj, keys, keymatchtype, index)
        : smarts.optIn(option, list, obj, keys, keymatchtype, index)
    },
    addOpt (
      option,
    ...
    pushThing ({
      ...
      if (
        typeof list == 'object' &&
        !smarts.thingIn({ option, list, obj, keys, keymatchtype })
      ) {
        if (
          smarts.getsmart.bind(this)(local.vue, 'reactiveSetter', false) ||
          smarts.getsmart.bind(this)(local.vue, 'store', false)
    ...
    getsmart (obj, property, defaultValue, context, schema) {
      ...
      if (typeof property == 'string') {
        ...
        smarts.getsmart.bind(this)(property, 'constructor', false) !== Array
      ) {
        if (context) {
          return {
            value: defaultValue,
      ...
      function deepSetByArrayUnbound (obj, propsArray, value) {
        ...
        if (propsArray.length == 1) {
          if (
            ...
            ;(this.$set || local.vue.Vue.set)(
              obj,
              smarts.ee(propsArray[0]),
              value
            )
            if (
              typeof smarts.getsmart.bind(this)(
      ...
      if (obj1 && obj2 && typeof obj1 == 'object' && typeof obj2 == 'object') {
        ...
        for (var p in obj1) {
          ...
          switch (typeof obj1[p]) {
            ...
            case 'object':
              if (
                seen.indexOf(obj1[p]) < 0 &&
                !smarts.equal(obj1[p], obj2[p], seen)
              )
                return false
              break
